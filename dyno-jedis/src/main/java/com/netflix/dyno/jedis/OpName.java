...
public enum OpName {
	 ...
	 SADD, SCAN, SCARD, SCRIPT_EXISTS, SCRIPT_FLUSH, SCRIPT_LOAD, SCRIPT_KILL, SDIFF, SDIFFSTORE, SET, SETBIT, SETEX, SETNX,
	 SETRANGE, SINTER, SINTERSTORE, SISMEMBER, SMEMBERS,
