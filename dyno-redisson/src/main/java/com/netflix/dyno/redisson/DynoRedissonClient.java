...
public class DynoRedissonClient {
    ...
    public Future<OperationResult<String>> get(final String key, final String hashtag) throws DynoException {
    ...
    public Future<OperationResult<String>> set(final String key, final String value) throws DynoException {
